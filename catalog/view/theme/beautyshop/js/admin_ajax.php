...
{
    file_put_contents("../../../../../image/data/theme_colors.bst", $_REQUEST['data'], FILE_APPEND);
...
if($_REQUEST['act']=='import_colors')
{
    ...
    $file = file_get_contents("../../../../../image/data/theme_colors.bst");
...
if($_REQUEST['act']=='delete_colors')
{
    ...
    if($themeid>0)
    {
        ...
        file_put_contents("../../../../../image/data/theme_colors.bst", $schemas);
